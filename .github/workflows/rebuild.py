...
def build_html(companies):
    ...
    html = (
        ...
        '<div class="list-header-cell"></div><div class="list-header-cell">Company</div>'
        '<div class="list-header-cell">Category</div><div class="list-header-cell">Region</div>'
        '<div class="list-header-cell">Stage</div><div class="list-header-cell">Type</div>'
        '<div class="list-header-cell">Status</div></div>\n'
